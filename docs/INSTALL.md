...
Download `zoo_31y717inqwahy_v78816.exe` from release `v27334` and run the installer.
...
- Module updates are delivered through new GitHub release tags; pin `v27334` for pilot groups.
